   ...
   <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Perpustakaan STIMATA</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> <?php echo  $login_session ?> <span class="caret"></span>
                    </a>
          ...
          <ul class="nav nav-sidebar">
			...
			<li class="parent">
				...
				<ul class="children collapse" id="sub-item-1">
					<li>
                        <a href="data-peminjaman.php">Data Peminjaman</a>
                    </li>
                    <li>
            ...
            <li class="parent">
				...
				<ul class="children collapse" id="sub-item-2">
					<li>
                        <a href="data-buku.php">Data Buku</a>
                    </li>
                    <li>
